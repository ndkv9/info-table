export const usersDiff = [
  ...
  },
  {
    ...
    diff: [{ field: 'name', oldValue: 'Michel', newValue: 'Michael' }],
  },
  {
    ...
    diff: [
      {
        field: 'name',
        oldValue: 'Michael',
        newValue: 'Constantine Prescott Nathaniel Jr.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    diff: [{ field: 'name', oldValue: 'Constantine P. N.', newValue: 'Joe' }],
  },
  {
    id: '57c1fd5d-a11c-433c-8820-a79bbffe6e60',
    timestamp: new Date('2020/2/23').getTime(),
    diff: [{ field: 'name', oldValue: 'Joe', newValue: 'Mo' }],
  },
  {
